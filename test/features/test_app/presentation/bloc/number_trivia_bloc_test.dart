...
import 'package:test_app/core/util/input_converter.dart';
...
import 'package:test_app/features/test_app/presentation/bloc/bloc.dart';
import 'package:test_app/features/test_app/presentation/bloc/number_trivia_bloc.dart';
...
void main() {
  ...
  MockGetRandomTrivia mockGetRandomNumberTrivia;
  MockInputConverter mockInputConverter;
  
  setUp(() {
    mockGetConcreteNumberTrivia = MockGetConcreteNumberTrivia();
    mockGetRandomNumberTrivia = MockGetRandomTrivia();
    mockInputConverter = MockInputConverter();
  ...
  group("GetTriviaForConcreteNumber", () {
    ...
    test(
      "should the InputConverter to validate and convert the string to an unsigned integer",
          () async {
        // arrange
